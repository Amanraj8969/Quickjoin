package org.jhipster.quickjoin.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("org.jhipster.quickjoin.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("org.jhipster.quickjoin.security.DomainUserDetailsService", "createSpringSecurityUser");
